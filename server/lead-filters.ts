...
/**
 * Lead status. Today the outreach status; when a CRM status column is added, change this one
 * expression (for example COALESCE(NULLIF(l.crm_status,''),l.outreach_status)) and the list of
 * values in shared/lead-filters.ts.
 */
export const leadStatusSql = 'l.outreach_status';
