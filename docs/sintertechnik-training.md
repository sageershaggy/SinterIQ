# Sintertechnik qualification training

Migrated from the original project instructions. Review the policy and examples before publishing a training version.
